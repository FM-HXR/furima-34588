...
ActiveRecord::Schema.define(version: 2021_03_07_073141) do
  ...
  create_table "brand_tags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "item_tag_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "item_id", null: false
    t.bigint "brand_tag_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["brand_tag_id"], name: "index_item_tag_relations_on_brand_tag_id"
  ...
  add_foreign_key "item_tag_relations", "brand_tags"
